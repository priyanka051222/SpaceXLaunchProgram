    ...
    <Card className={classes.root}>
      <CardActionArea>
        ...
        <CardContent>
          <List dense={dense}>
            <ListItem>
              <ListItemText primary={flightItem.title} />
            </ListItem>
            <ListItem>
              <ListItemText primary='Mission Ids' secondary={flightItem.id} />
            </ListItem>
            <ListItem>
              <ListItemText primary='Launch Year' secondary={flightItem.year} />
            </ListItem>
            <ListItem>
              <ListItemText
